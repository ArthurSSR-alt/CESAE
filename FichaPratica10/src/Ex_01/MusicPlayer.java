...
public class MusicPlayer {
    ...
    //Método para adicionar musicas ao arraylist
    public void addMusica(Musica musicaNova) {
        this.programacao.add(musicaNova);

    }

    //método para remover musicas de arraylist
    ...
    //método para trocar musicas ao arraylist
    ...
    //método para remover todas as musicas ao arraylist
    public void limparProgramacao(){
        this.programacao.clear();
    }

    //método para imprimir relatorio que imprima na consola todas as musicas da programação
    ...
    //Ex: Musica1: The scientist | Rock Alternativo | Coldplay | 260

    // crie o método que calcule e imprima na consola o formate hora:minuto:segundo, a duração total da programação definida
public void calcularDuracao(){
        int totalSegundosAlbum=0;
        for (Musica musicaAtual:this.programacao){
            totalSegundosAlbum+=musicaAtual.getSegundos();
